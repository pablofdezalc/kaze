...
void Display_Text(cv::Mat &img_rgb, int npoints1, int npoints2, int nmatches, int ninliers, float ratio, int index)
{
    ...
    sprintf(cad,"NNDR Matching %.2f",DRATIO);

    if( index == 0 )
    {
        putText(img_rgb,cad,cv::Point(20,30),CV_FONT_HERSHEY_DUPLEX,.75,CV_RGB(255,255,0),2,8,false);
    }
    else if( index == 1 )
    {
        putText(img_rgb,cad,cv::Point(20,30),CV_FONT_HERSHEY_DUPLEX,.75,CV_RGB(255,0,0),2,8,false);
    }
    else if( index == 2 )
    {
        putText(img_rgb,cad,cv::Point(20,30),CV_FONT_HERSHEY_DUPLEX,.75,CV_RGB(0,255,0),2,8,false);
    }

    sprintf(cad,"# Points Image 1: %d, # Points Image 2: %d",npoints1,npoints2);

    if( index == 0 )
    {
        putText(img_rgb,cad,cv::Point(20,img_rgb.rows-70),CV_FONT_HERSHEY_DUPLEX,.75,CV_RGB(255,255,0),2,8,false);
    }
    else if( index == 1 )
    {
        putText(img_rgb,cad,cv::Point(20,img_rgb.rows-70),CV_FONT_HERSHEY_DUPLEX,.75,CV_RGB(255,0,0),2,8,false);
    }
    else if( index == 2 )
    {
        putText(img_rgb,cad,cv::Point(20,img_rgb.rows-70),CV_FONT_HERSHEY_DUPLEX,.75,CV_RGB(0,255,0),2,8,false);
    }

    sprintf(cad,"# Matches: %d, # Inliers: %d, Ratio %.2f",nmatches,ninliers,ratio);

    if( index == 0 )
    {
        putText(img_rgb,cad,cv::Point(20,img_rgb.rows-30),CV_FONT_HERSHEY_DUPLEX,.75,CV_RGB(255,255,0),2,8,false);
    }
    else if( index == 1 )
    {
        putText(img_rgb,cad,cv::Point(20,img_rgb.rows-30),CV_FONT_HERSHEY_DUPLEX,.75,CV_RGB(255,0,0),2,8,false);
    }
    else if( index == 2 )
    {
        putText(img_rgb,cad,cv::Point(20,img_rgb.rows-30),CV_FONT_HERSHEY_DUPLEX,.75,CV_RGB(0,255,0),2,8,false);
    }
}

...
public:
    ...
    // Setters
    void Set_Scale_Offset(const float& soffset) {
        soffset_ = soffset;
    }

    void Set_SDerivatives(const float& sderivatives) {
    ...
    void Set_Verbosity_Level(const bool& verbosity) {
        verbosity_ = verbosity;
    }

    void Set_KContrast(const float& kcontrast) {
        kcontrast_ = kcontrast;
    }

    void Set_Detector_Threshold(const float& dthreshold) {
        dthreshold_ = dthreshold;
    }

    void Set_Diffusivity_Type(const int& diffusivity) {
        diffusivity_ = diffusivity;
    }

    void Set_Descriptor_Mode(const int& descriptor_mode) {
        descriptor_mode_ = descriptor_mode;
    }

    void Set_Upright(const bool& use_upright) {
        use_upright_ = use_upright;
    }

    void Set_Extended(const bool& use_extended) {

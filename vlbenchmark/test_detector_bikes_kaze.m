% test_detector_bikes_kaze.m
% Script for testing KAZE using the vlbenchmark in the Bikes dataset
% Author: Pablo F. Alcantarilla
% Date: 27-12-2015
%**************************************************************************
function test_detector_bikes_kaze()
...
featExtractors{end+1} = localFeatures.KAZE('dthreshold',0.0008,'omax',4,'nsublevels',4,'diffusivity',1,'descriptor',5);
